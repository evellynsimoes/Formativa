...
//                         setEditando(false);
//                         setIdEditando(null);
//                         setNovoGestor({ nome: '', username: '', telefone: '', NI: '', password: '', escolha: 'P', data_nascimento: '', data_contratacao: '' });
//                         setVisible(true);
//                     }} disabled={isLoading}>
...
//                         <form>
//                             <input type="text" placeholder="Nome" value={novoGestor.nome} onChange={e => setNovoProfessor({ ...novoGestor, nome: e.target.value })} />
//                             <input type="text" placeholder="Usuário" value={novoGestor.username} onChange={e => setNovoProfessor({ ...novoGestor, username: e.target.value })} />
//                             <input type="text" placeholder="Telefone (xx)xxxxx-xxxx" value={novoGestor.telefone} onChange={e => setNovoProfessor({ ...novoGestor, telefone: e.target.value })} />
//                             <input type="text" placeholder="NI" value={novoGestor.NI} onChange={e => setNovoProfessor({ ...novoGestor, NI: e.target.value })} />
//                             {!editando && (
//                                 <input type="password" placeholder="Senha" value={novoGestor.password} onChange={e => setNovoProfessor({ ...novoGestor, password: e.target.value })} />
//                             )}
//                             <input type="date" placeholder="Data de Nascimento" value={novoGestor.data_nascimento} onChange={e => setNovoProfessor({ ...novoProfessor, data_nascimento: e.target.value })} />
